...
namespace MathFunctions
{
    ...
    public class MathParser
    {
        ...
        public decimal Calculate(string Formula, string hesaplamatipi)
        {
            try
            {
            ...
            {
                throw new Exception("Hesaplama formülü içerisinde bilinmeyen formül yapısı kullanılmış.\nLütfen formül yapısını düzeltin.", ex);
            }
        }
